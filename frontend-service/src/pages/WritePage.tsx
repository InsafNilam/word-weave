...
const Write = () => {
  ...
  const [cover, setCover] = useState<UploadResponse | undefined>(undefined);
  const [img, setImg] = useState<UploadResponse | undefined>(undefined);
  const [video, setVideo] = useState<UploadResponse | undefined>(undefined);
