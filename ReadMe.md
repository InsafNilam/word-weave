...
- Docker (version 20.x+ recommended)
- Docker Compose (v2+)
...
5. Copy the value of CLERK_WEBHOOK_SIGNING_SECRET from the dashboard, add it to your environment variables, and restart the User Service.
6. The User Service will update MongoDB based on webhook event callbacks.
